...
interface IDeviceActiveLineChartProps {
  title: string;
  seriesName: string;
  xAxisData: string[];
  data: number[];
}
export default function DeviceActiveLineChart(props: IDeviceActiveLineChartProps){
  const {title, seriesName,xAxisData, data} = props;
  ...
  return (
    <Box style={{height:200,lineHeight:200}}>
